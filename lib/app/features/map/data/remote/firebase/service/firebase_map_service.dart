...
import 'package:yandex_sirius/app/features/map/data/remote/firebase/models/coordinate/firebase_api_coordinate_model.dart';
...
class FirebaseMapService{
  ...
  Future<Stream<FirebaseApiMapTagModel>> getFriendCoordinateStream(List<FirebaseApiMapTagModel> friendsList)async{
  ...
  Future<FirebaseApiCoordinateModel> setUserCoordinateStream(FirebaseApiCoordinateModel coordinate){
     //TODO: create stream and return it with
    throw UnimplementedError();
  }
